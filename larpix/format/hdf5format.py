...
'''
        ...
        for i, packet in enumerate(packet_list):
            if version != '0.0' and packet.__class__ in _format_method_lookup[version].get(message_dset.name, tuple()):
                encoded_message = _format_method_lookup[version][message_dset.name][packet.__class__](packet, counter=message_dset.shape[0] + len(messages))
